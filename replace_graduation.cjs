...
console.log('Reading Chapter1Screen.jsx...');
console.log('Original size:', content.length);

// Find the start of graduation scenario
const startMarker = "    // SCENARIO 1.1: Tốt nghiệp phổ thông\n    if (scenario === 'graduation') {";
const startIndex = content.indexOf(startMarker);

if (startIndex === -1) {
    console.log('ERROR: Could not find graduation scenario start marker');
    process.exit(1);
}

console.log('Found graduation scenario at index:', startIndex);

// Find the end - look for the next scenario or CHOICE
...
console.log('Graduation scenario ends at index:', endIndex);
console.log('Scenario length:', endIndex - startIndex);

// New graduation scenario content
const newGraduationScenario = `    // SCENARIO 1.1: Tốt nghiệp phổ thông (IMPROVED)
    if (scenario === 'graduation') {
...
// Replace
const newContent = content.substring(0, startIndex) + newGraduationScenario + content.substring(endIndex);
...
console.log('✅ Successfully replaced graduation scenario!');
console.log('Total steps: 16 (0-15)');
